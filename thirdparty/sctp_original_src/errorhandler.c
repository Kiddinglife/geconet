/* $Id: errorhandler.c 2199 2009-08-31 06:43:13Z dreibh $
 * --------------------------------------------------------------------------
 *
 *           //=====   //===== ===//=== //===//  //       //   //===//
 *          //        //         //    //    // //       //   //    //
...
int eh_recv_chunk(SCTP_simple_chunk * errchunk)
{
	...
	case ECC_STALE_COOKIE_ERROR:
		...
		msm_read_cookie_staleness((SCTP_simple_chunk *)errchunk);
		result = 0;
		break;
	...
	case ECC_UNRECOGNIZED_PARAMS:
		...
		if (ntohs(header->param_type) == VLPARAM_UNRELIABILITY) {
