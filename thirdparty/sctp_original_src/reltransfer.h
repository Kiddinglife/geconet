/* $Id: reltransfer.h 2199 2009-08-31 06:43:13Z dreibh $
 * --------------------------------------------------------------------------
 *
 *           //=====   //===== ===//=== //===//  //       //   //===//
 *          //        //         //    //    // //       //   //    //
 ...
 */
int
rtx_timer_cb (TimerID tid, void *data1, void *data2);
 ...
 */
int
rtx_update_retrans_chunks (void *data_chunk, unsigned int dest);
 ...
 */
int
rtx_t3_timeout (void *rtx_instance, unsigned int address, unsigned int mtu,
                internal_data_chunk_t ** rtx_chunks);
