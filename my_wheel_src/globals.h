...
#define   timenow_ms(timeval_ptr) ((ulonglong)((timeval_ptr)->tv_sec * 1000 + (timeval_ptr)->tv_usec/1000))
#define   timenow_us(timeval_ptr) ((ulonglong)((timeval_ptr)->tv_sec * 1000000 + (timeval_ptr)->tv_usec))
