...
inline int mtra_read_ip4_socket() { return mtra_ip4_socket_despt_; }
inline int mtra_read_ip6_socket() { return mtra_ip6_socket_despt_; }
inline  int mtra_read_icmp_socket() { return mtra_icmp_socket_despt_; }
inline void mtra_zero_ip4_socket() { mtra_ip4_socket_despt_ = 0; }
inline void mtra_zero_ip6_socket() { mtra_ip6_socket_despt_ = 0; }
inline void mtra_zero_icmp_socket() { mtra_icmp_socket_despt_ = 0; }
