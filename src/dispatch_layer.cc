...
//=======================  mdis  dispatcher module which is current module  =============================
/**
 ...
 */
void mdis_conenct(unsigned short noOfOutStreams,
...
inline uchar alloc_init_ack_chunk(uint initTag, uint rwnd, ushort noOutStreams,
        ushort noInStreams,
        uint initialTSN)
{
...
inline void remove_simple_chunk(uchar chunkID)
{
    uchar cid = chunkID;
    if (simple_chunks_[chunkID] != NULL)
    {
...
int get_local_addreslist(sockaddrunion* local_addrlist,
...
inline uint get_local_tag()
{
    return curr_channel_ == NULL ? 0 : curr_channel_->local_tag;
}
inline uint get_remote_tag()
{
        ...
        void* ulp_data)
{
    ...
    mdis_conenct(noOfOutStreams,curr_geco_instance_->noOfInStreams,
            dest_su,noOfDestinationAddresses,support_pr_);
