...
static int checksumAlgorithm = MULP_CHECKSUM_ALGORITHM_MD5;
static bool librarySupportsPRSCTP = true;
static bool supportADDIP = true;
	...
	geco_instance_t** out)
{
	...
	*out = NULL;
	...
	std::list<channel_t*>* list_result = NULL;
	...
	if (with_ipv4)
	{
		...
		mtra_set_expected_event_on_fd(mtra_ip4_socket_despt_, EVENTCB_TYPE_SCTP, POLLIN | POLLPRI, cbunion, 0);
	}
	if (with_ipv6)
	{
		ipv6_users++;
