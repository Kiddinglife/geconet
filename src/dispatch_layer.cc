        ...
        sockaddrunion * dest_addr)
{
    ...
    {
        /*11) it is init chunk*/
        init_chunk = find_chunk(((dctp_packet_t*) dctp_packet)->chunk,
...
uchar* dispatch_layer_t::find_chunk(uchar * packet_value, int packet_val_len,
        uchar chunk_type)
{
    int chunk_len = 0;
    int read_len = 0;
    ...
    {
        event_logii(verbose, "find_chunk()::packet_val_len=%d, read_len=%d",
