...
int mulp_get_path_params(unsigned int connectionid, short path_id,
	path_infos_t* status);
int mulp_set_path_params(unsigned int connectionid, short path_id,
	path_infos_t *new_status);
...
extern void mulp_set_socket_read_handler(
	socket_read_start_cb_t& mtra_socket_read_start,
	socket_read_end_cb_t& mtra_socket_read_end, void* start_arg = 0,
	void* end_args = 0);
extern void mulp_enable_socket_read_handler();
extern void mulp_disable_socket_read_handler();

extern void mulp_set_mtra_select_handler(select_cb_t& mtra_select_start, select_cb_t& mtra_select_end, void* start_arg = 0, void* end_args = 0);
