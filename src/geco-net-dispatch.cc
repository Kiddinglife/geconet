...
bool mrecv_update_fragments(recv_controller_t* mrecv, uint chunk_tsn)
{
  /*
   * Algorithm:
   * case one: given 1-4.5-7.8-10.11, cstna=1, assume chunk_tsn=6
   *  loop1: lo=cstna+1=1+1=2, hi=4-1=3, ubetween(2,6,3)=false->update lo=5+1=6
   *  loop2: lo==6, hi=7-1=6, ubetween(3,6,6)=true
   *                            gapsize=6-6+1=1
   *
   */

  static uint lo, hi, gapsize;
  static segment32_t *frag, *new_frag, *lo_frag;
