...
int mpath_read_path_status(short pathID)
{
  ...
  assert(
      pmData->path_params != NULL && "mpath_read_path_status: path_params is NULL");
  assert(
      pathID >= 0 && pathID < pmData->path_num
          && "mpath_read_path_status: invalid path ID");
...
int mpath_do_hb(int pathID)
{
  ...
  assert(
      pathID >= 0 && pathID < path_ctrl->path_num
          && "mpath_do_hb: invalid path ID");
...
void mpath_verify_unconfirmed_paths(uint noOfPaths, ushort primaryPathID)
{ // mpath_set_paths
