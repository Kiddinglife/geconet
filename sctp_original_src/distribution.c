...
/******************** Declarations ****************************************************************/
static bool sctpLibraryInitialized = false;
/*
...
void* mfc_get_flowctrl(void)
{
	if (curr_channel_ == NULL)
	{
		event_log(VVERBOSE, "mfc_get_flowctrl: association not set");
		return NULL;
	}
	else
	{
