 ...
 *                  OR -1 if not found !!!!!!!
 */
static gint32 retrieveVLParamFromString(guint16 paramType, guchar * mstring,
        guint16 length)
{
    guint16 curs;
    guint16 pType;
 ...
 */
static gint32 setIPAddresses(unsigned char *mstring, guint16 length,
        ...
        gboolean ignoreLast)
{
    ...
    if (myTypes & SUPPORT_ADDRESS_TYPE_IPV4)
    {
        ...
        while ((cursrel = retrieveVLParamFromString(VLPARAM_IPV4_ADDRESS,
                &mstring[cursabs], (guint16)(length - cursabs))) >= 0)
        {
    ...
    if (myTypes & SUPPORT_ADDRESS_TYPE_IPV6)
    {
        ...
        while ((cursrel = retrieveVLParamFromString(VLPARAM_IPV6_ADDRESS,
...
void ch_enterCookiePreservative(ChunkID chunkID, unsigned int lifespanIncrement)
{
    ...
    {
        error_log(ERROR_MAJOR,
                "ch_enterCookiePreservative : chunk already completed");
        return;
    }
    ...
    {
        error_log(ERROR_MAJOR,
                "ch_enterCookiePreservative: chunk type not init");
    }
}
        ...
        gboolean* peerSupportsPRSCTP, gboolean* peerSupportsADDIP)
{
    ...
    *destSet = FALSE;
    ...
    while (curs < vlp_totalLength)
    {
        ...
        {
            result = retrieveVLParamFromString(VLPARAM_IPV4_ADDRESS,
...
unsigned int ch_stalenessOfCookieError(ChunkID chunkID)
{
    ...
    {
        error_log(ERROR_MAJOR,
                "ch_stalenessOfCookieError: chunk type not error");
        return 0;
    }
}
